...
import 'package:syncfusion_flutter_examples/widgets/animateOpacityWidget.dart';
import 'package:syncfusion_flutter_examples/samples/chart/cartesian_charts/bar_series/customized_bar_chart.dart';
import 'package:syncfusion_flutter_examples/widgets/bottom_sheet.dart';
import 'package:syncfusion_flutter_examples/widgets/search_bar.dart';
import 'package:syncfusion_flutter_examples/widgets/widget.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _init() async {
    final ByteData data = await rootBundle.load('assets/images/dashline.png');
                ...
                Stack(children: <Widget>[
                  _lightThemeSelected
                      ? Container(
                          ...
                          child: Image.asset('assets/images/image_nav_banner.png',
                              fit: BoxFit.cover),
                        )
                      : Container(
                          padding: const EdgeInsets.fromLTRB(10, 30, 30, 10),
                          child: Image.asset(
                              'assets/images/image_nav_banner_darktheme.png',
                              fit: BoxFit.cover),
                        )
                ]),
                Expanded(
                                            ...
                                            Padding(
                                                padding:
                                                    const EdgeInsets.fromLTRB(
                                                        25, 0, 0, 0),
                                                child: Image.asset(
                                                    'assets/images/img_xamarin_ui.png',
                                                    fit: BoxFit.contain,
                                                    height: 28,
                                                    width: 28)),
                                            Container(

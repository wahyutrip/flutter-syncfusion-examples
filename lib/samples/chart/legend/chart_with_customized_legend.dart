...
dynamic getImage(int index) {
  final dynamic images = <dynamic>[
    Image.asset('assets/images/truck_legend.png'),
    Image.asset('assets/images/car_legend.png'),
    Image.asset('assets/images/bike_legend.png'),
    Image.asset('assets/images/cycle_legend.png')
  ];
  return images[index];
}
